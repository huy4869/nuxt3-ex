<template>
  ...
  <el-form-item :prop='nameRef' :error='errorResponse' :rules="rules" class="relative" :class="[iconLeft ? 'input-button-icon' : '', classSpacing]">
    <el-input
      ref='refEl'
      v-model='value'
...
<!--    </template>-->
    ...
    <img v-if="iconLeft" class="absolute top-2.5 left-2" width="20" height="20" :src="iconLeft" alt="iconLeft">
  </el-form-item>
</template>
